  ...
  <div class="container">
    <div class="row d-none d-xl-block d-xl-flex" style="background-color: #E8E9E7; margin-top: 100px;">
      ...
      ?>
        ...
        <div class="col-4">
          <div class="card" style="width: 470px; height: 490px; margin-top: 70px;">
            <div class="card-body">
              <div>
                <span class="card-title" style="font-size: 26px; font-weight: bold;"><?= $obj['prod_name'] ?></span>
                <a href="#">
                  <i class="fa fa-heart" 
                      style="font-size: 26px; padding-left: 170px;"
                      id="heart"
                      data-prod-id="<?= $obj['id'] ?>"
              ...
              <h6 class="card-subtitle mb-2 text-muted" style="font-size: 18px; margin-top: 10px;">TWD <span style="font-size: 36px; color: #FF9F1C; font-weight: bold;"><?= $obj['rental_charge'] ?></span>/ 天</h6>
              ...
              <div class="dropdown">
                ...
                <div class="time-picker">
                  <input type="text" name="daterange" id="rental_day" value="09/03/2021 - 09/03/2021" style="width: 430px;
                                          height: 48px;
                                          position: relative;" />
                  <i class="far fa-calendar-alt" style="position: absolute;
                            top: 67px;
                            left: 400px;font-size: 24px;"></i>
                </div>
              </div>
              <hr>
              <p>*詳細租賃方式請見 <a href="./notice.php" style="color: black; text-decoration: none; font-weight: 600;">租賃須知</a></p>
              <button class="btn btn-warning btn-outline-secondary" 
                      ...
                      data-rental-charge="<?= (int)$obj['rental_charge'] ?>" 
    ...
    <div class="d-block d-xl-none">
          ...
          <div style="position: relative;">
            <img src="./images/bag-blue.jpeg" alt="" style="width: 100%; margin-top: 20px;">
          ...
          <div style="text-align: center; margin-top: 20px;">
            <a href="./images/bag-blue.jpeg" data-lightbox="roadtrip2"  style="display: none;">
              <img src="./images/bag-blue.jpeg" alt="">
            </a>
            <a href="./images/bag-blue-back.jpeg" data-lightbox="roadtrip2"  style="display: none;">
              <img src="./images/bag-blue-back.jpeg" alt="">
            </a>
            <a href="./images/bag-blue-other.jpeg" data-lightbox="roadtrip2"  style="display: none;">
              <img src="./images/bag-blue-other.jpeg" alt="">
            </a>
          </div>
          <?php
          if(isset($_GET['prod_id'])){
            $sql = "SELECT * FROM `product` WHERE `id` = 153";
            $obj = $pdo->query($sql)->fetch();
          ?>
      <div class="col">
        <div class="card" style="width: 366px; margin-top: 20px;">
          <div class="card-body" style="margin-top: 10px;">
            ...
            <h6 class="card-subtitle mb-2 text-muted" style="font-size: 14px; margin-top: 10px;">TWD <span style="font-size: 24px; color: #FF9F1C; font-weight: bold;"><?= $obj['rental_charge'] ?></span>/ 天</h6>
          ...
          <div class="dropdown">
            ...
            <div class="time-picker">
              <input type="text" name="daterange" id="rental_day" value="09/03/2021 - 09/03/2021" style="width: 330px;
                                    height: 48px;
                                    position: relative;" />
              <i class="far fa-calendar-alt" style="position: absolute;
                      top: 65px;
                      left: 300px;font-size: 24px;"></i>
            </div>
          </div>
          <hr>
    ...
    <div class="row d-none d-xl-block d-xl-flex" style="text-align: center; margin-top: 100px;">
      <p style="font-size: 36px;">增加背包的容量並提升可見度</p>
      <p style="font-size: 26px;">這個獨特的配件，能與MAMMUT的狩獵包結合使用。採用500D CORDURA®布料製成，可以增加背包置物的容量</p>
    </div>
    <div class="row d-block d-xl-none" style="text-align: center; margin-top: 60px;">
      <p style="font-size: 24px;">增加背包的容量並提升可見度</p>
      <p style="font-size: 16px;">這個獨特的配件，能與MAMMUT的狩獵包結合使用。採用500D CORDURA®布料製成，可以增加背包置物的容量</p>
    </div>
    ...
    <div class="row d-none d-xl-block d-xl-flex" style="width: 1020px; margin: 50px 150px;">
      <div>
        ...
        <p style="font-size: 18px;">最受歡迎的Lithium系列中小升數的背包，可多用途使用，也可用於越野跑或需要多次移動的戶外攀岩行程。</p>
      </div>
      <div>
        <p style="font-size: 18px; font-weight: bold; border-bottom: 2px solid;">商品資訊 | Product Information</p>
        <p style="font-size: 18px;">-CONTACT VENT™背負系統，並有通風減壓的EVA材質背墊<br>
          -輕量透氣的EVA肩墊<br>
          -可掛鑰匙的拉鍊口袋<br>
          -專用水袋空間<br>
          -肩帶上的拉鍊網眼袋可放手機<br>
      ...
      <div>
        ...
        <p style="font-size: 18px;">當我們今天登山的計畫是在A處扎營，再前往山頂，若還背著所有家當，那可能會去了半條命，這時候就會需要我們的攻頂包啦！！！
          這款In & Out是Mountain系列中，最輕與收納體積最小的一款多功能後背包，收納時可以直接塞進前方的網布口袋，讓攜帶更便利。19L的背包容量，配備有透氣網布肩帶與胸帶、外部收納網袋、內部主隔層、水袋隔層，側邊水壺口袋、外部壓縮束帶、外掛繩鍊與登山杖掛點，適合作為攻頂包與戶外隨身背包使用！
        </p>
      </div>
    ...
    <div class="row d-block d-xl-none" style="width: 100%; margin-top: 50px; margin-left: 0;">
      <div>
        <p style="font-size: 18px; font-weight: bold; border-bottom: 2px solid;">商品特色 | Product Features</p>
        <p style="font-size: 16px;">最受歡迎的Lithium系列中小升數的背包，可多用途使用，也可用於越野跑或需要多次移動的戶外攀岩行程。</p>
      </div>
      <div>
        <p style="font-size: 18px; font-weight: bold; border-bottom: 2px solid;">商品資訊 | Product Information</p>
        <p style="font-size: 16px;">-CONTACT VENT™背負系統，並有通風減壓的EVA材質背墊<br>
          -輕量透氣的EVA肩墊<br>
          -可掛鑰匙的拉鍊口袋<br>
          -專用水袋空間<br>
          -肩帶上的拉鍊網眼袋可放手機<br>
