    ...
    <div class="row d-none d-xl-block d-xl-flex" style="margin-top: 100px;">
      ...
      <div class="col-10" style="padding-right: 0;">
        <div class="row" style="text-align: center;">
          <p style="font-size: 48px; font-weight: bold;">買裝備</p>
        </div>
        <!-- 商品一覽 -->
        <div class="row">
                ...
                <div class="col mt-5">
                  <div class="card" style="width: 300px;">
                    <div class="hover14 column">
                      <figure>
                        <a href="eq_detail_buy.php?parent_id=<?= $_GET['parent_id'] ?>&cat_id=<?= $_GET['cat_id'] ?>&prod_id=<?= $obj['id'] ?>"><img src="./images/<?= $obj['prod_main_img'] ?>" class="card-img-top" alt="..."></a>
                      </figure>
                    </div>
                    <div class="card-body">
                      <h5 class="card-title"><?= $obj['prod_name'] ?></h5>
                      <span class="card-text" style="margin-left: 140px;">TWD <span style="color: #FF9F1C; font-weight: bold; font-size: 20px;"><?= $obj['prod_price'] ?></span></span>
                    </div>
                  </div>
                </div>
              <?php
            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination pagination-lg">
                ...
                <li class="page-item <?php if ($page == 1)  echo 'disabled' ?>">
                  <a class="page-link" href="eq_house_buy.php?parent_id=<?= $_GET['parent_id'] ?>&cat_id=<?= $_GET['cat_id'] ?>&page=1" aria-label="Previous" style="color: #ABADB2;">
                ...
                ?>
                  <li class="page-item <?= $strClass ?>">
                    <a class="page-link" href="eq_house_buy.php?parent_id=<?= $_GET['parent_id'] ?>&cat_id=<?= $_GET['cat_id'] ?>&page=<?= $i ?>"><?= $i ?></a>
                  </li>
                <?php
                }
                ?>
                ...
                <li class="page-item <?php if ($page == $totalPages)  echo 'disabled' ?>">
                  <a class="page-link" href="eq_house_buy.php?parent_id=<?= $_GET['parent_id'] ?>&cat_id=<?= $_GET['cat_id'] ?>&page=<?= $totalPages ?>" aria-label="Next" style="color: #ABADB2;">
    ...
    <div class="row d-block d-xl-none" style="margin-top: 30px;">
      <div>
        <div style="border-bottom: 3px solid black; width: 100px; margin: 0 auto;">
          <p style="font-size: 30px; font-weight: bold; text-align: center; margin: 0 auto;">買裝備</p>
        </div>
      </div>
      <div style="margin-top: 20px; text-align: center;">
        ...
        foreach ($arr as $obj) {
        ?>
          <a style="font-size: 18px; color: black; text-decoration: none;" href="eq_house_buy.php?parent_id=21&cat_id=<?= $obj['id'] ?>"><?= $obj['cat_name'] ?>/</a>
        <?php } ?>
      </div>
      <?php if (isset($_GET['cat_id'])) { ?>
        <div class="group" style="display: flex; flex-wrap: wrap;">
          ...
          ?>
            <div class="card col-6" style="height: 310px; margin-top: 20px;">
              <a href="eq_detail_buy.php?parent_id=<?= $_GET['parent_id'] ?>&cat_id=<?= $_GET['cat_id'] ?>&prod_id=<?= $obj['id'] ?>">
              ...
              <div class="card-body">
                ...
                <span class="card-text" style="position: absolute; top: 260px; left: 50px;">TWD <span style="color: #FF9F1C; font-weight: bold; font-size: 20px;"><?= $obj['prod_price'] ?></span></span>
              </div>
            </div>
          <?php
          }
